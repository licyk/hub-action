...
class BucketManager:
    def __init__(self, dic_data, valid_ids=None, max_size=(7680,4320), divisible=32, step_size=8, min_dim=256, base_res=(1024,1024), bsz=1, world_size=1, global_rank=0, max_ar_error=64, seed=42, dim_limit=1024, debug=False):
...
if __name__ == "__main__":
    ...
    image_folder = r"F:\AIxunlianji\20240111\freng\1_freng"  # 图像文件夹的实际路径
    image_class_folder_out = r"C:\Users\81808\Desktop\asd"  # 图像分类文件夹的输出路径
    file_index = 10000
    ...
    bm = BucketManager(image_data, debug=False,divisible=64,max_ar_error=1,dim_limit=1024) #调整这些参数就能控制buckets的生成数量，每个bucket中的图片数量
